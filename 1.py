...
ban = """\033[1;34m
   _____ _    _          _____  ______  __      ____        ___  
  / ____| |  | |   /\   |  __ \|  ____| \ \    / /_ |      / _ \ 
 | (___ | |__| |  /  \  | |__) | |__     \ \  / / | |     | | | |
  \___ \|  __  | / /\ \ |  _  /|  __|     \ \/ /  | |     | | | |
  ____) | |  | |/ ____ \| | \ \| |____     \  /   | |  _  | |_| |
 |_____/|_|  |_/_/    \_\_|  \_\______|     \/    |_| (_)  \___/ 
                                                                                                                                                                                       
                                              
\033[1;34m
\033[1;32m ➢ Fb :    no infomation
\033[1;32m ➢ Tool :  Share Ảo V1.0  
"""
import os
import platform
import time
...
while True:
    try:
        ...
        print('\n\033[38;5;245m[\033[38;5;9m!\033[38;5;245m] \033[38;5;9mCẢM ƠN BẠN ĐÃ DÙNG TOOL !\033[0m')
        sys.exit()
